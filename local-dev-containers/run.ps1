...
if ($All) {
    $Services = @("user", "session", "social", "games", "store", "tic-tac-toe", "checkers", "chess", "frontend-platform", "frontend-tic-tac-toe")
...
$ValidServices = @("user", "session", "social", "games", "store", "tic-tac-toe", "checkers", "chess", "frontend-platform", "frontend-tic-tac-toe")
$Profiles = @()
