...
public class LobbyController {
    ...
    public ResponseEntity<LobbyResponseModel> create(
        ...
        Lobby lobby = lobbyService.createLobby(game, owner, model, token);
    ...
    public ResponseEntity<LobbyResponseModel> updateSettings(
        ...
        Lobby lobby = lobbyService.updateSettings(LobbyId.from(id), PlayerId.get(token), model);
        return ResponseEntity.ok(LobbyResponseModel.from(lobby));
    }
    ...
    public ResponseEntity<LobbyResponseModel> close(
        ...
        Lobby lobby = lobbyService.closeLobby(LobbyId.from(id), PlayerId.get(token));
        return ResponseEntity.ok(LobbyResponseModel.from(lobby));
    }
    ...
    public ResponseEntity<LobbyResponseModel> start(
        ...
        Lobby lobby = lobbyService.startLobby(LobbyId.from(id), PlayerId.get(token), token);
        return ResponseEntity.ok(LobbyResponseModel.from(lobby));
    }
}