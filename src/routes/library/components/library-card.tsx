...
export default function LibraryCard({ title, image, playtime, friendCount }: Props) {
    return (
        <article className="flex flex-col group relative overflow-hidden cursor-pointer select-none justify-end bg-cover px-4 py-2 rounded-lg h-64" style={{ backgroundImage: `url("${image}")` }}>
            ...
            <section className="relative z-10">
                ...
                <Row gap={Gap.Large} responsive={false}>
                    <Row gap={Gap.None} responsive={false}>
