...
import AboutTab from "@/routes/profile/dialogs/settings-dialog/about-tab";
import ModulesTab from "@/routes/profile/dialogs/settings-dialog/modules-tab";
import PictureTab from "@/routes/profile/dialogs/settings-dialog/picture-tab";
