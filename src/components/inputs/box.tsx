...
export default function InputBox({ label, description, placeholder, disabled, required, value, onChange }: Props) {
    return (
        <label className="flex flex-col">
            ...
            <textarea placeholder={placeholder} disabled={disabled} value={value} onChange={onChange} className="rounded-lg py-2 h-36 bg-bg-2 w-full min-h-10 px-3 placeholder:text-fg-2 disabled:text-fg-2 font-semibold resize-none" />
