...
export default function FavouriteCard({image, title, description, date}: Props) {
    return (
        <article
            ...
            <section
                className="absolute inset-0 bg-black/40 group-hover:bg-black/50 rounded-lg transition-colors duration-200"/>
